...
This directory contains the EasyCrypt development that accompanies the paper. It
models the components of IKEv2 that the analysis uses, states the security
notions of the paper as games, and verifies the reductions between them. Twelve
modules, about 3100 lines and 144 verified statements. No proof obligation is
...
| `Instantiate.ec` | The negotiated suite of the paper, the derived block counts, the segment profiles of both schedules, and the concrete compression count. |
...
The quantum random oracle follows the discipline of EasyPQC: the oracle is
...
are statements about the primitives and not about the games of the paper. They
...
`Acce.ec`, so the shape of the bound of the paper is derived and the two
